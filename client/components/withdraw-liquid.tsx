...
const WithdrawLiquid: React.FC = () => {
  ...
  return (
    <div className="h-fit w-full rounded-xl border border-[#303054] bg-[#262638] px-6 py-3">
      <div className="mt-3">
        <h4 className="text-xl font-semibold text-white">Withdraw LSTs</h4>
        <p className="mt-1 text-sm font-medium text-muted-foreground">
          Remove your LSTs from the pool
        </p>
      </div>
                    ...
                    <FormControl>
                      <div className="relative">
                        <Input
                          ...
                          placeholder={`0 ${
                            TOKENS.find((t) => t.value === withdrawToken)?.label
                          }`}
                          {...field}
                        />
                        <p
      ...
      <div className="mb-2 mt-6">
        ...
        {address && (
          <Button
            ...
            className="w-full rounded-lg bg-[#395C6A] py-6 text-sm font-semibold text-white/80 transition-all hover:bg-[#34535f] hover:text-white/90 disabled:bg-[#557c8d] disabled:text-white/50 disabled:opacity-80"
          >
            Withdraw {TOKENS.find((t) => t.value === withdrawToken)?.label}
          </Button>
        )}
      </div>
    </div>
